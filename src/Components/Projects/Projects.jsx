...
import lclcinema from '../../assets/lclcinema.png'
const Projects = () => {
  return (
        ...
        <div className="projects-container">
            ...
            */}
            ...
            <div className="project-box">
              ...
              <h3>254 Site Sinema</h3>
              <p>Built with vanilla javascript, this web app  offers a user-friendly interface for exploring movies across various genres, discovering top-rated films and latest releases.</p>
              <img src={lclcinema} alt="Project4" />
              <div className="project-links">
                <a href="https://project-local-sinema.vercel.app/" className="btn">visit</a>
                <a href="git@github.com:LizWaweru/Local-Sinema.git" className="github-link">
                  <i className='bx bxl-github'></i>
                </a>
              </div>   
            </div>
            ...
            <div className="project-box">
              ...
              <h3>Alma Finder</h3>
              <p>This project provides an overview about higher education in Kenya. It showcases universities details including their programs, facilities and their geographical location.</p>
